...
//  Navigation
//
//  Created by Vladislav Green on 3/3/23.
//
...
//    var authorizationType: BiometricType
    ...
    init(
        ...
        localizedReason: String = "LogIn",
        localizedFallbackTitle: String = "Enter App Password",
        authorizationType: BiometricType = .none
    ) {
        self.policy = policy
...
//        self.authorizationType = authorizationType
    ...
    func authorizeIfPossible(_ authorizationFinished: @escaping (Bool, _ errorString: String?) -> Void) {
        
        self.canEvaluate { (canEvaluate, _, canEvaluateError) in
